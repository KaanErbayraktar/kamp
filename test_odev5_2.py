...
class test_checkout():
  ...
  def test_checkoutname(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "*[data-test=\"lastName\"]").send_keys("Işık")
